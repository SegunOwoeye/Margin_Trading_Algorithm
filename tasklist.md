...
- [x] Address problem with short side assets in the orderbook file
- [x] Attempt running on PC
- [x] Before testing with real money, implement a method to settle the loaned money after every trade
...
- [x] Create a method for centralising the choice of currency
### Additional Projects
